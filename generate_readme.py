...
# Local graduation projects: (num, display_name, gitee_repo_slug or None, stack)
PROJECTS = [
    ...
    (31, "高校宿舍管理系统", None, "SpringBoot+Vue"),
    (32, "宠物健康管理系统", None, "SpringBoot+Vue"),
    (33, "动物园综合管理系统", None, "SpringBoot+Vue"),
    (34, "电影院购票选座系统", None, "SpringBoot+Vue"),
    (35, "自习室座位预约管理系统", None, "SpringBoot+Vue"),
    (36, "仓储WMS管理系统", None, "SpringBoot+Vue"),
